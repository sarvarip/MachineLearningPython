...
matrix = lag_feature( matrix, [1,2], ["avg_sell_month_per_shop"] )
...
matrix = lag_feature( matrix, [1,2], ["avg_sell_month_per_item"] )
...
# matrix = lag_feature( matrix, [1,2], ["avg_sell_month_per_subtype"] )
...
# matrix = lag_feature(matrix, [1,2], ['avg_sell_month_per_shop_subtype'])
...
X_train = matrix.loc[matrix['date_block_num'] < 34].drop(['item_cnt_month'], axis=1) #date_block_num is not useful
...
X_test['item_target_enc'] = 0
X_test['shop_target_enc'] = 0
X_test['city_target_enc'] = 0
X_test['subtype_target_enc'] = 0
X_test['month_target_enc'] = 0
X_test['ifs_target_enc'] = 0
X_test['isfs_target_enc'] = 0

kf = KFold(n_splits=5, shuffle=False)
for tr_ind, val_ind in kf.split(X_train):
    X_tr, X_val = X_train.iloc[tr_ind], X_train.iloc[val_ind]
    X_train.loc[X_train.index[val_ind], 'item_target_enc'] = X_val['item_id'].map(X_tr.groupby('item_id')['item_cnt_month'].mean())
    X_test['item_target_enc'] += 0.2*X_test['item_id'].map(X_tr.groupby('item_id')['item_cnt_month'].mean())
    X_train.loc[X_train.index[val_ind], 'shop_target_enc'] = X_val['shop_id'].map(X_tr.groupby('shop_id')['item_cnt_month'].mean())
    X_test['shop_target_enc'] += 0.2*X_test['shop_id'].map(X_tr.groupby('shop_id')['item_cnt_month'].mean())
    X_train.loc[X_train.index[val_ind], 'city_target_enc'] = X_val['city'].map(X_tr.groupby('city')['item_cnt_month'].mean())
    X_test['city_target_enc'] += 0.2*X_test['city'].map(X_tr.groupby('city')['item_cnt_month'].mean())
    X_train.loc[X_train.index[val_ind], 'subtype_target_enc'] = X_val['subtype'].map(X_tr.groupby('subtype')['item_cnt_month'].mean())
    X_test['subtype_target_enc'] += 0.2*X_test['subtype'].map(X_train.groupby('subtype')['item_cnt_month'].mean())
    X_train.loc[X_train.index[val_ind], 'month_target_enc'] = X_val['month'].map(X_tr.groupby('month')['item_cnt_month'].mean())
    X_test['month_target_enc'] += 0.2*X_test['month'].map(X_train.groupby('month')['item_cnt_month'].mean())
    X_train.loc[X_train.index[val_ind], 'ifs_target_enc'] = X_val['item_first_sale'].map(X_tr.groupby('item_first_sale')['item_cnt_month'].mean())
    X_test['ifs_target_enc'] += 0.2*X_test['item_first_sale'].map(X_train.groupby('item_first_sale')['item_cnt_month'].mean())
    X_train.loc[X_train.index[val_ind], 'isfs_target_enc'] = X_val['item_shop_first_sale'].map(X_tr.groupby('item_shop_first_sale')['item_cnt_month'].mean())
    X_test['isfs_target_enc'] += 0.2*X_test['item_shop_first_sale'].map(X_train.groupby('item_shop_first_sale')['item_cnt_month'].mean())
    
# Fill NaNs
X_train['item_target_enc'].fillna(0.3343, inplace=True)
X_test['item_target_enc'].fillna(0.3343, inplace=True)
X_train['shop_target_enc'].fillna(0.3343, inplace=True)
X_test['shop_target_enc'].fillna(0.3343, inplace=True)
X_train['city_target_enc'].fillna(0.3343, inplace=True)
X_test['city_target_enc'].fillna(0.3343, inplace=True)
X_train['subtype_target_enc'].fillna(0.3343, inplace=True)
X_test['subtype_target_enc'].fillna(0.3343, inplace=True)
X_train['month_target_enc'].fillna(0.3343, inplace=True)
X_test['month_target_enc'].fillna(0.3343, inplace=True)
X_train['ifs_target_enc'].fillna(0.3343, inplace=True)
X_test['ifs_target_enc'].fillna(0.3343, inplace=True)
X_train['isfs_target_enc'].fillna(0.3343, inplace=True)
X_test['isfs_target_enc'].fillna(0.3343, inplace=True)

X_train.item_target_enc = X_train["item_target_enc"].astype(np.float16)
X_test.item_target_enc = X_test["item_target_enc"].astype(np.float16)
X_train.shop_target_enc = X_train["shop_target_enc"].astype(np.float16)
X_test.shop_target_enc = X_test["shop_target_enc"].astype(np.float16)
X_train.city_target_enc = X_train["city_target_enc"].astype(np.float16)
X_test.city_target_enc = X_test["city_target_enc"].astype(np.float16)
X_train.subtype_target_enc = X_train["subtype_target_enc"].astype(np.float16)
X_test.subtype_target_enc = X_test["subtype_target_enc"].astype(np.float16)
X_train.subtype_target_enc = X_train["month_target_enc"].astype(np.float16)
X_test.subtype_target_enc = X_test["month_target_enc"].astype(np.float16)
X_train.subtype_target_enc = X_train["ifs_target_enc"].astype(np.float16)
X_test.subtype_target_enc = X_test["ifs_target_enc"].astype(np.float16)
X_train.subtype_target_enc = X_train["isfs_target_enc"].astype(np.float16)
X_test.subtype_target_enc = X_test["isfs_target_enc"].astype(np.float16)
