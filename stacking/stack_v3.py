...
rf = RandomForestRegressor(n_estimators=100, min_samples_leaf=30, max_depth=10, n_jobs=-1)
...
Y_train_level2 = matrix.loc[matrix['date_block_num'].isin([22, 33]), 'item_cnt_month']
...
for cur_block_num in [22, 33]:
    ...
    X_train_level2[dates_train_level2 == cur_block_num] = np.c_[pred_gb, pred_cb, pred_rf]
